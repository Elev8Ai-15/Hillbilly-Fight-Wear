...
export const mensClothing: ShopProduct[] = [
  ...
  { id: 'm14', title: 'T-Shirt - Sit On My Deck (Staunch Properties)', vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/staunch-properties-tshirt.jpg', backImage: '/images/products/staunch-properties-tshirt.jpg', type: 'garment', garmentType: 'tshirt', sizes: ['S','M','L','XL','XXL','XXXL'], colors: ['Espresso','Black','Heather Tan'] }
]
