...
export const womensClothing = [
  { id: 'w1', title: "Women's Tank - It's A Fun Ride", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w1-fun-ride-tank.png', backImage: '/images/products/web/m5-fun-ride-back.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'fun-logo' },
  { id: 'w2', title: "Women's Tank - HFW", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w2-hfw-tank.png', backImage: '/images/products/web/m3-hfw-classic-back.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'hfw-logo' },
  { id: 'w3', title: "Women's Tank - Thump a Stranger", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w3-thump-tank.png', backImage: '/images/products/web/m8-thump-back.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'thump-a-stranger' },
  { id: 'w4', title: "Women's Tank - Thumpin Is Lovin", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w4-thumpin-tank.png', backImage: '/images/products/web/d7-back-thumpin.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'thumpin-is-lovin-pink' },
  { id: 'w5', title: "Women's Tank - Yes You Can", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w5-yesyoucan-tank.png', backImage: '/images/products/web/d10-back-yesyoucan.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'yes-you-can' },
  { id: 'w6', title: "Women's Tank - GNF", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w6-gnf-tank.png', backImage: '/images/products/web/m6-gnf-back.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'gnf' }
]
...
export const hats = [
  ...
  { id: 'h6', title: 'Adjustable Hat - Hard Hittin', vendor: 'Hillbilly Fightwear', price: '$35.00', priceNum: 35, image: '/images/products/web/h6-hard-hittin.png', type: 'garment', garmentType: 'trucker-hat', sizes: ['One Size'], colors: ['Black'] },
