...
export const womensClothing = [
  { id: 'w1', title: "Women's Tank - It's A Fun Ride", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w1-fun-ride-tank.png', backImage: '/images/products/web/d3-back-thump.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'fun-logo' },
  { id: 'w2', title: "Women's Tank - HFW", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w2-hfw-tank.png', backImage: '/images/products/web/d9-back-myob.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'hfw-logo' },
  { id: 'w3', title: "Women's Tank - Thump a Stranger", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w3-thump-tank.png', backImage: '/images/products/web/d5-back-cockfighter.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'thump-a-stranger' },
  { id: 'w4', title: "Women's Tank - Thumpin Is Lovin", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w4-thumpin-tank.png', backImage: '/images/products/web/d11-back-community.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'thumpin-is-lovin-pink' },
  { id: 'w5', title: "Women's Tank - Yes You Can", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w5-yesyoucan-tank.png', backImage: '/images/products/web/d6-back-hcf.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'yes-you-can' },
  { id: 'w6', title: "Women's Tank - GNF", vendor: 'Hillbilly Fightwear', price: '$30.00', priceNum: 30, image: '/images/products/web/w6-gnf-tank.png', backImage: '/images/products/web/d10-back-yesyoucan.png', type: 'garment', garmentType: 'tank-womens', sizes: ['S','M','L','XL'], colors: ['Black','White'], graphicId: 'gnf' }
]
